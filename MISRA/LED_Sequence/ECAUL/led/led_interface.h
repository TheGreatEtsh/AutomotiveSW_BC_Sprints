...
typedef struct 
{
	uint8_t_ uint8_ledID;
	uint8_t_ uint8_ledPort;
	uint8_t_ uint8_ledPin;
}str_LED_config_t;
...
/**
 * \Syntax          : LED_on(uint8_t_ uint8_ledID)
...
/**
 * \Syntax          : LED_off(uint8_t_ uint8_ledID)
...
/**
 * \Syntax          : LED_toggle(uint8_t_ uint8_ledID)
