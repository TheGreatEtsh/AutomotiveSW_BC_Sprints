...
/******************************************************************************
* \Syntax          : enu_dio_status_t_ dio_pinPullUp(uint8_t_ uint8_port_number, uint8_t_ uint8_pin_number, uint8_t_ uint8_pullUpState)
...
*										DIO_WRONG_VALUE
*******************************************************************************/
enu_dio_status_t_ dio_pinPullUp(uint8_t_ uint8_port_number, uint8_t_ uint8_pin_number, uint8_t_ uint8_pullUpState);
